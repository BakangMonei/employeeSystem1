public class SupportStuff extends Employees {
    ...
    public double calculateCarAllowance() {
        double carAllowance = (this.getHoursWorked() * this.getRateOfPay()) * SupportStuff.carAllowanceRate;
