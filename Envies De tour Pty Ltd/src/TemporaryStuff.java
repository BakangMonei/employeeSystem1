public class TemporaryStuff extends Employees {
   ...
   //Constructors
    ...
    public double calculateCarAllowance() {
        double carAllowance = (this.getHoursWorked() * this.getRateOfPay()) * TemporaryStuff.carAllowanceRate;
